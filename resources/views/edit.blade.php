      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
          	<center>
             <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Edit Details</h3>
             </center>
   ...
   <form action="/editaction/{{$value->id}}" method="post" style="margin-top:100px;">
	@csrf
    	      ...
    	      <div class=" mb-4" style="margin-left: 40px; margin-top: 25px;">
               ...
               <input type="number" name="bookno" value="{{$value->bookno}}" style="width:250px;margin-left: 10px;">

              </div>
            	<div class=" mb-4" style="margin-left: 40px;">
              	  <label  class=" fw-bold"> Name</label>

  <select name="name" value="{{$value->name}}" class="select" style="width:250px;margin-left: 35px;">
    ...
    <option value="making of new india">Making of new india</option>
      ...
      <select name="auther" value="{{$value->auther}}" class="select"   style="width:250px;margin-left: 30px;">
     ...
     <input type="text" name="edition" value="{{$value->edition}}" style="width:250px;margin-left: 30px;">

              </div>
    <div class=" mb-4" style="margin-left: 40px;">
        <label class="fw-bold"  >Publisher</label>

     <input type="text" name="publisher" value="{{$value->publisher}}" style="width:250px;margin-left: 15px;">

              </div>           
       

              <button type="submit" name="submit" value="update" class="btn btn-secondary btn-lg mb-1" style="margin-left:180px;">Update</button>
